...
FastioServer::FastioServer(const std::string& db_path) :
edb_(db_path)
{
    
}

FastioServer::FastioServer(const std::string& db_path, const size_t tm_setup_size) :
    edb_(db_path)
{
...
// std::list<index_type> FastioClient::search_parallel_full(const SearchRequest& req)
// {
//     std::list<index_type> results;
