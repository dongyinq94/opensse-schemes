...
#spirt_debug_prog   = outter_env.Program('spirt_debug',    ['test_spirt.cpp']     + objects["spirt"])
spirt_client       = outter_env.Program('spirt_client',   ['spirt_client.cpp']   + objects["spirt"])
spirt_server       = outter_env.Program('spirt_server',   ['spirt_server.cpp']   + objects["spirt"])
...
env.Alias('spirt', [spirt_client, spirt_server])
